    ...
    with open(outfile, 'w') as f:
        ...
        for row in summary:
            ...
            if target_sequence:
                ...
                BED_score = 1
                if strand == "+":
                    target_start_absolute = target_start_relative + int(row[2]) - 35
                    target_end_absolute = target_end_relative + int(row[2]) - 35
                elif strand == "-":
                    target_start_absolute = int(row[2]) + 35 - target_end_relative
                    target_end_absolute = int(row[2]) + 35 - target_start_relative
                else:
